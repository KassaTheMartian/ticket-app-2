...
<head>
    ...
    <title>Ticket Sending Confirmation</title>
</head>
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; margin: 0; padding: 20px; background-color: #f0f2f5; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: linear-gradient(135deg, #0056b3 0%, #0088ff 100%); color: #ffffff; text-align: center; padding: 30px 20px;">
            <h1 style="margin: 0; font-size: 28px; font-weight: 600; letter-spacing: 0.5px; color: #ffffff;">Ticket Confirmation</h1>
            <p style="margin: 10px 0 0; font-size: 16px; opacity: 0.9;">Thank you for your submission</p>
        </div>
        ...
        <div style="padding: 30px 40px; color: #2d3748;">
            ...
            <p style="margin: 0 0 25px; font-size: 16px; line-height: 1.6;">Your ticket has been successfully submitted. Here are the details of your ticket:</p>
            ...
            <div style="background-color: #f8fafc; border-left: 4px solid #0056b3; border-radius: 6px; padding: 25px; margin-bottom: 25px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 12px 0; color: #718096;">Sending Time:</td>
                        <td style="padding: 12px 0; color: #2d3748;">{{ $data['created_at'] }}</td>
                    </tr>
                </table>
            </div>

            <p style="margin: 0 0 10px; color: #475569;">If you have any questions, please don't hesitate to contact our support team.</p>
            
            <p style="margin: 25px 0 10px; color: #475569;">Best regards,</p>
            <p style="margin: 0; font-weight: 600; color: #0056b3;">Tickies Support Team</p>
        </div>
