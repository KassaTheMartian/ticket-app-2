...
<div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h5 class="m-0 font-weight-bold text-primary">Customers List</h5>
            <a href="{{ route('admin.customers.create') }}" class="btn btn-primary btn-icon-split">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="customersTable" width="100%" cellspacing="0">
