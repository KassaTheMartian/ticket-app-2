                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-primary" ng-disabled="selectedRoles.length === 0">
                                        Confirm (@{{selectedRoles.length}} Permissions)
                                    </button>
                                </div>
                            </div>
                            <!-- Route List -->
...
<script type="text/javascript">
    ...
    app.controller('roleController', function($scope) {
        // Filter out auth routes right when receiving the data
        var allRoles = angular.fromJson('<?php echo json_encode($routes); ?>');
        ...
        // Generate prefix groups (excluding auth routes)
        ...
        $scope.selectByPrefix = function(prefix) {
            ...
            if (allSelected) {
                // Unselect all roles with this prefix
                ...
                // Select all roles with this prefix that aren't already selected
                filteredRoles.forEach(function(role) {
